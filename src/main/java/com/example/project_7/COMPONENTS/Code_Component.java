...
public class Code_Component extends Application {
    // a demo is created in DELETE.java file
    // I have to export the DELETE file as Library(jar)
    // Then add the jar as maven libraby to use it
